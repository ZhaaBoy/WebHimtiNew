...
<head>
    ...
    <title>HIFEST MOBILE LEGENDS 2023</title>
...
<body>
    <div class="card" style="text-align: center;">
        <h1>Berhasil</h1>
        <p>Terima Kasih <b>{{ $nama_team }}</b> Sudah Mendaftar HIFEST MOBILE LEGENDS 2023 </p>
        <hr class="garis">
        <p>Silakan klik link dibawah ini untuk memasuki group HIFEST MOBILE LEGENDS 2023 </p>
        ...
        <h5>Whatsapp :<a href="https://api.whatsapp.com/send?phone=6282261038505 " style="text-decoration: none;">
                082261038505 (Haidar Nabil
                Hibatullah)</a></h5>
        <div class="footer">
