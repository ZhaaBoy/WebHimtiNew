...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="google-site-verification" content="PsPlAczBFw2NjJ0TV8-ydNPeBtBOZZnivWZYHxl_ASQ"/>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-menu-wrapper" id="navbarSupportedContent">
                    <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('sertifikat')" href="{{ route('sertifikat') }}">Sertifikat</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle @yield('pendaftaran')" href="#"
                             ...
                             <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item nav-link  @yield('bootcamp')"
                                        href="{{ route('kelompok_belajar.create') }}">Kelompok Belajar</a></li>
                                <li><a class="dropdown-item nav-link  @yield('bootcamp')"
                                        href="{{ route('web.create') }}">Lomba Poster</a></li>
                                <li><a class="dropdown-item nav-link  @yield('bootcamp')"
                                        href="{{ route('mls.create') }}">Lomba Mobile Legends</a></li>
                                <li><a class="dropdown-item nav-link  @yield('bootcamp')"
                                        href="{{ route('sri.create') }}">Lomba Rakit PC</a></li>
                                <li><a class="dropdown-item nav-link  @yield('bootcamp')"
                                        href="{{ route('seminars.create') }}">Seminar</a></li>
                                <li><a class="dropdown-item nav-link  @yield('bootcamp')"
                                        href="{{ route('btcmps.create') }}">Bootcamp 2023</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
    ...
    @foreach ($footers as $footer)
        <section class="contact-details" id="contact-details-section">
            <div class="col-12 col-md-12 col-lg-12 grid-margin text-center">
                ...
                <a href="https://www.instagram.com/himtiumt/"><span class="mdi mdi-instagram"> himtiumt</span></a>
        ...
        <footer class="border-top">
            <p class="text-center text-muted pt-4">{{ $footer->copyright }}<a href="{{ route('home') }}"
                    ...
                    Belajar</a>.
                        ...
                        <p class="text-center text-muted pt-1">Sponsored by <a href="https://bantenhost.com/"
                    class="px-1">BantenHost.Com</a> & Partner <a href="https://khatulistiwa.id/">Khatulistiwa.ID</a>
            </p>
        </footer>
    @endforeach
    </div>
