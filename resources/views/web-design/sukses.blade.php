...
@section('tittle', 'HIMTI-UMT | Pendaftaran Lomba WEb Design Sukses')
            ...
            <div class="page-error">
                <div class="page-inner text-center">
                    ...
                    <div class="page-description">
                        Terima Kasih <b>{{ $web->nama_team }}</b> Sudah Mendaftar <i class="text-dark text-bold">HIFEST LOMBA POSTER 2023</i>
                    </div>
                    <br>
