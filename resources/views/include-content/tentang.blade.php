        ...
        <div class="container">
                ...
                <div class="container" class="faq section-bg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member">
                                <img src="{{ asset('public/assets/struktur/kaprodi.jpg') }}" class="img-fluid" alt="">
                        ...
                        <div class="col-md-3" data-aos="zoom-in" data-aos-delay="300">
                            <div class="member">
                                <img src="{{ asset('public/assets/struktur/sekpro.jpg') }}" class="img-fluid" alt="">
                                <div class="member-info">
                                    <div class="member-info-content">
            ...
            <section id="team" class="team">
                <div class="container">
                    <div class="section-title" data-aos="fade-up">
                        <h2>HIMTI</h2>
                        <p>Struktural Periode 2023-2024</p>
                    </div>
