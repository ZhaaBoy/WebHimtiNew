    ...
    <div class="content-wrapper">
        <div class="container">
                ...
                <div class="row">
                    <div class="owl-carousel owl-theme grid-margin">
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('assets/images/java.png') }}" width="89" height="89"
                                        alt="" class="img-customer">
                                    <p class="m-0 py-3 text-muted">Java adalah bahasa pemrograman yang dapat dijalankan di
                                        berbagai
                                        komputer termasuk telepon genggam. Bahasa ini awalnya dibuat oleh James Gosling saat
                                        masih bergabung
                                        di Sun Microsystems, yang saat ini merupakan bagian dari Oracle dan dirilis tahun
                                        1995.</p>
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('assets/images/html-coding.png') }}" width="95" height="95"
                                        alt="" class="img-customer">
                                    <p class="m-0 py-3 text-muted">Hypertext Markup Language adalah bahasa markah standar
                                        untuk dokumen
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('assets/images/computer.png') }}" width="85" height="85"
                                        alt="" class="img-customer">
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('assets/images/android-logo.png') }}" width="89" height="89"
                                        alt="" class="img-customer">
                                    <p class="m-0 py-3 text-muted"> Studio adalah Integrated Development Enviroment untuk
                                        sistem operasi
                                        Android, yang dibangun di atas perangkat lunak JetBrains IntelliJ IDEA dan didesain
                                        khusus untuk
            ...
            <section class="digital-marketing-service" id="digital-marketing-section">
                ...
                @forelse ($sharings as $index => $sharing)
                    @if ($index % 2 == 0)
                                ...
                                <div class="col-5 col-lg-5 flex-item grid-margin" data-aos="fade-left">
                                    ...
                                    <div class="col-lg-9 col-xl-8 p-0">
                                        ...
                                        <p class="pb-2 font-weight-medium text-muted">
                                            ...
                                            <br> <b> Ruangan : {{ $sharing->ruangan }} </b>


                                            <br> <b> Pemateri : {{ $sharing->pemateri }} </b>
                                        </p>
