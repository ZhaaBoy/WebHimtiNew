...
@section('content')
    ...
    <div class="container mt-5 section-body">
        {{-- <h1 class="text-center text-bold text-dark col-md-12">MOHON MAAF PENDAFTARAN KELOMPOK BELAJAR DI BUKA KEMBALI 2024</h1> --}}

        <h1 class="text-center text-bold text-dark col-md-12">Pendaftaran Kelompok Belajar 2024</h1>
        ...
        <form action="{{ route('kelompok_belajar.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-select form-control" name="bidang" id="bidang">
                    ...
                    <option name="bidang" id="bidang" value="Mobile Developer">Android Developer</option>
                    <option name="bidang" id="bidang" value="Network Engineer">Network Engineer</option>
                    <option name="bidang" id="bidang" value="UI/UX Designer">UI/UX Designer</option>
                </select>
            </div>
            <div class="form-group">
