...
@section('content')
    ...
    <div class="banner">
        ...
        <!-- vidio ---->
    <!--<div class="vidio">-->
    <!--  <video src="{{ asset('assets/img/bootcamp2023.mp4')}}" controls loop autoplay class="embed-responsive" ></video>-->
    <!--</div>-->
        <!-- akhir vidio---->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-5 flex-item grid-margin" data-aos="fade-left">
                        ...
                        <div class="col-lg-9 col-xl-8 p-0">
                                <p class="pt-4 pb-2 font-weight-medium text-muted">
                                    <b>Hari/Tanggal : {{ $item->jadwal }}
                                        <br> Pelaksanaan : {{ $item->lokasi }}
                                </p>
                        </div>
